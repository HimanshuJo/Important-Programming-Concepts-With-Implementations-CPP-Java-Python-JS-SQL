    ...
    int openLock(vector<string>&deadends, string target){
        ...
        while (!q.empty()){
            ...
            while (qSz--){
                ...
                //     string nwCode1="";
                //     for (int x=0; x<i; ++x){
                //         nwCode1+=to_string(curr[i]);
                //     }
                //     nwCode1+=to_string(newDig1);
                //     for (int x=i+1; x<curr.length(); ++x){
                //         nwCode1+=to_string(curr[i]);
                //     }
                //     set<string>::iterator it1=snSt.find(nwCode1);
                //     set<string>::iterator it11=deadSet.find(nwCode1);
                //     if (it1==snSt.end()&&it11==deadSet.end()){
                //         q.push(nwCode1);
                ...
                //     string nwCode2="";
                //     for (int x=0; x<i; ++x){
                //         nwCode2+=to_string(curr[i]);
                //     }
                //     nwCode2+=to_string(newDig2);
                //     for (int x=i+1; x<curr.length(); ++x){
                //         nwCode2+=to_string(curr[i]);
                //     }
                //     set<string>::iterator it1_=snSt.find(nwCode2);
                //     set<string>::iterator it11_=deadSet.find(nwCode2);
                //     if (it1_==snSt.end()&&it11_==deadSet.end()){
                //         q.push(nwCode2);
