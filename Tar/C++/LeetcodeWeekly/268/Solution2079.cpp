...
/*
You want to water n plants in your garden with a watering can. The plants are arranged in a 
row and are labeled from 0 to n - 1 from left to right where the ith plant is located at x = i. 
...
ith plant needs, and an integer capacity representing the watering can capacity, 
