...
public class Solution1943_SweepLine {
	...
	public static void main(String[] args) {
		Solution1943_SweepLine obj = new Solution1943_SweepLine();
		int[][] A = { { 4, 5, 9 }, { 8, 12, 5 }, { 4, 7, 19 }, { 14, 15, 1 }, { 3, 10, 8 }, { 17, 20, 18 },
				{ 7, 19, 14 }, { 8, 16, 6 }, { 14, 17, 7 }, { 11, 13, 3 } };
		int[][] A2 = { { 1, 4, 5 }, { 1, 4, 7 }, { 4, 7, 1 }, { 4, 7, 11 } };
		int[][] A3 = { { 1, 4, 5 }, { 4, 7, 7 }, { 1, 7, 9 } };
		obj.splitPainting(A);
		obj.splitPainting(A2);
		obj.splitPainting(A3);
	}
}
