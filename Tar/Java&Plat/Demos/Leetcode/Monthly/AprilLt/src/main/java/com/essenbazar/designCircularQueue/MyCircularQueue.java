 ...
 */
package com.essenbazar.designCircularQueue;
...
FIFO (First In First Out) principle and the last position is connected back to the 
...
there is a space in front of the queue. 
