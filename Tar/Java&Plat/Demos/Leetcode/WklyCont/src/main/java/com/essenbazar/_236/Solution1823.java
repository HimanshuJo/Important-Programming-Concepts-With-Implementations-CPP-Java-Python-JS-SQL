...
More formally, moving clockwise from the ith friend brings you to the (i+1)th friend for
...
public class Solution1823 {
	...
	public static void main(String[] args) {
		Solution1823 myObj = new Solution1823();
		int n = 5;
		int k = 2;
		System.out.println(myObj.findTheWinner(n, k));
	}
