package com.essenbazar.aTeam_231A;
/*

One day three best friends Petya, Vasya and Tonya decided to form a team and take part in programming contests. 
Participants are usually offered several problems during programming contests. 
Long before the start the friends decided that they will implement a problem if at least two of them are 
sure about the solution. Otherwise, the friends won't write the problem's solution.
...
public class Solution {
    ...
    public static void main(String[] args) {
        try (Scanner myObj = new Scanner(System.in)) {
			...
			int count_ = 3;
			int[] probAppr = new int[count_];
			int res = 0;
			for (int i = 0; i < input; ++i) {
			    int count = 0;
			    for (int j = 0; j < count_; ++j) {
			        probAppr[j] = myObj.nextInt();
			    }
