...
Each number is made from digits 0 or 1. The contestants should write a new number 
corresponding to the given pair of numbers. The rule is simple: 
...
He saw that he can perform these operations on numbers of length ∞ 
...
He is a good fellow so he won't give anyone very big numbers and he always 
...
It is guaranteed that the numbers are made from 0 and 1 only and that their 
length is same. The numbers may start with 0. The length of each number doesn't exceed 100.
Output
